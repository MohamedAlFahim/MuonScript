...
enum {
  ...
  aux_sym_muonscript_module_repeat1 = 22,
  aux_sym_doc_comment_block_repeat1 = 23,
  aux_sym_dotted_name_repeat1 = 24,
  aux_sym_imported_module_members_repeat1 = 25,
};
...
static uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    [sym_muonscript_module] = STATE(37),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_muonscript_module_repeat1, 2),
  [19] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_muonscript_module_repeat1, 2), SHIFT_REPEAT(28),
  [22] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_muonscript_module_repeat1, 2), SHIFT_REPEAT(30),
  [25] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_muonscript_module_repeat1, 2), SHIFT_REPEAT(33),
  [28] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [30] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [32] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [34] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_muonscript_module, 1),
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dotted_name_repeat1, 2),
  [38] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dotted_name_repeat1, 2), SHIFT_REPEAT(35),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dotted_name, 1, .production_id = 1),
  [43] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dotted_name, 2, .production_id = 3),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_imported_module_members, 1),
  [49] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module_member_import, 1, .production_id = 5),
  [53] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_imported_module_members_repeat1, 2),
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_imported_module_members_repeat1, 2), SHIFT_REPEAT(29),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_imported_module_members, 2),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module_member_import, 3, .production_id = 9),
  [64] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_doc_comment_block_repeat1, 2), SHIFT_REPEAT(18),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_doc_comment_block_repeat1, 2),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 2, .production_id = 2),
  ...
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 4, .production_id = 4),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_named_function_definition, 5, .production_id = 7),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_from_statement, 4, .production_id = 6),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_named_function_definition, 4, .production_id = 7),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_named_function_definition, 6, .production_id = 8),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_named_function_definition, 5, .production_id = 8),
